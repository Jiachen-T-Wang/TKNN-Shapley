...
if dataset in big_dataset+OpenML_dataset:
    save_name = save_dir+'{}_{}_{}_Ndata{}_Nval{}_Nsample{}_BS{}_LR{}_Nrepeat{}_FR{}_Seed{}_NoisyData{}.data'.format(
        value_type, dataset, model_type, n_data, n_val, n_sample, batch_size, lr, n_repeat, flip_ratio, random_state, args.noisydata)
else:
...
x_train, y_train, x_val, y_val = get_processed_data(dataset, n_data, n_val, flip_ratio, noisy_data=args.noisydata)
